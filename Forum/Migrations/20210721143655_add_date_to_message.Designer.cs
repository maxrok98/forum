...
namespace Forum.Migrations
{
    ...
    [Migration("20210721143655_add_date_to_message")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forum.Models.Calendar", b =>
                {
            ...
            modelBuilder.Entity("Forum.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a20d04ad-b22a-4a73-b33d-7fff55191ba8",
                            Email = "admin@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAENCmgMcYrH9ybEODc9xqLo4vhWDySAJ/8FYeQLmAMkgoeTmUuXz+HtccbRO/rAXbEg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e1a30cd7-cd08-407b-b414-16cbeec7f8ba",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "412bc71c-0a39-420a-ba96-ecff3cd60f9d",
                            Email = "new@example.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "NEW@EXAMPLE.COM",
                            NormalizedUserName = "NEW",
                            PasswordHash = "AQAAAAEAACcQAAAAEMTlQNu/OoUiPuMdI2vAxnHDlMCBUwYJB7xvMkbcpyTcMzwmq/UTN6HmmRUbioDheA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "408a24b8-e8d4-4449-85b0-73908e913ad3",
                            TwoFactorEnabled = false,
                            UserName = "new",
                            Year = 0
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "aab8a4b0-f365-49cd-b2bd-b9963e536598",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f456522a-ba7f-4076-8b9a-075c0541a713",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Forum.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = "dde8b42a-591c-46e1-9de9-49be6442583e",
                            DateOfEvent = new DateTime(2021, 7, 22, 17, 36, 54, 289, DateTimeKind.Local).AddTicks(3407)
                        },
                        new
                        {
                            ...
                            UserId = "5736d00c-ee3f-4ea8-b965-d5a21642d06a",
                            DateOfEvent = new DateTime(2021, 7, 22, 17, 36, 54, 293, DateTimeKind.Local).AddTicks(5070)
                        });
                });
            ...
            modelBuilder.Entity("Forum.Models.Calendar", b =>
                {
                    b.HasOne("Forum.Models.Event", "Event")
                        .WithMany("Calendar")
            ...
            modelBuilder.Entity("Forum.Models.RefreshToken", b =>
                {
                    b.HasOne("Forum.Models.User", "User")
                        ...
                        .HasForeignKey("Forum.Models.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
